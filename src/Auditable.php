...
use DagaSmart\Auditing\Contracts\AttributeEncoder;
use DagaSmart\Auditing\Contracts\AttributeRedactor;
use DagaSmart\Auditing\Contracts\Auditable as ContractsAuditable;
use DagaSmart\Auditing\Contracts\Resolver;
use DagaSmart\Auditing\Events\AuditCustom;
use DagaSmart\Auditing\Exceptions\AuditableTransitionException;
use DagaSmart\Auditing\Exceptions\AuditingException;
...
trait Auditable
{
    ...
    protected function resolveUser()
    {
        ...
        if (is_subclass_of($userResolver, \DagaSmart\Auditing\Contracts\UserResolver::class)) {
