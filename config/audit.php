...
return [
    ...
    */
    ...
    'implementation' => DagaSmart\Auditing\Models\Audit::class,
    ...
    */
    ...
    'user' => [
        ...
        'resolver' => DagaSmart\Auditing\Resolvers\UserResolver::class,
    ],
    ...
    */
    'resolvers' => [
        'ip_address' => DagaSmart\Auditing\Resolvers\IpAddressResolver::class,
        'user_agent' => DagaSmart\Auditing\Resolvers\UserAgentResolver::class,
        'url' => DagaSmart\Auditing\Resolvers\UrlResolver::class,
    ],
